#Notes for the 06_25_19 me

#   Should seperate this lambda_function file from checkup_intent.py/guide_intent.py

#   For example have these functions in lambda_function file:
#       execute query, get_slots, close, build_validation_result
#   Everything else should be under the specific intent file.
...
def dispatch(intent_request):
    ...
    if intent_name == "CheckUp":
        #Give a question asking if the user needs help
        
        #Then, if the user reponds No, set this to fulfilled and have a leave message
        #   Future functionality add integration with site of disapearing thing.
        
        #If user repsonds yes, then call Guide intent
        return check_up(intent_request)
    ...
    elif intent_name == "Guide":
        return guide_intent.guide(intent_request)
